      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        ...
        {showBuilder ? (
          <button
            ...
            className="flex min-h-[12rem] flex-col items-center justify-center gap-2 rounded-md border border-dashed border-[var(--hair)] text-slate-400 transition-colors hover:border-[var(--acc)] hover:text-[var(--acc)]"
          >
