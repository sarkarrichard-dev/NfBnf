...
from trading_ai_engine.ml.ingest import default_cli_progress, scan_and_ingest
from trading_ai_engine.server.paths import ml_data_roots
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "into Trading AI Workstation SQLite (ml_datasets) for ML + AI digest. "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "If omitted, uses built-in roots: Your Trading Data/, Files To Teach AI/, "
            "and TRADING_AI_EXTRA_DATA_FOLDERS."
        ),
    )
    parser.add_argument(
        "--also-builtins",
