...
_CHUNK_DAYS = {
    "1m": 1, "3m": 7, "5m": 12, "15m": 30, "30m": 60,
    "1h": 80, "2h": 80, "4h": 80, "6h": 80, "1d": 0, "1w": 0,
}
...
if __name__ == "__main__":  # self-check — no network
    base = pd.DataFrame(
        {
            ...
            "open": range(15), "high": range(1, 16), "low": range(15),
    ...
    print("crypto.delta.market_data self-check ok — resample + resolution tables")
